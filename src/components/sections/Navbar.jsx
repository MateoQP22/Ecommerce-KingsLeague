            ...
            <nav className="nav">
                <div className="container f-elements f-elements--header">
                    ...
                    >
                        ...
                        >
                            <li>
                                <NavLink to="/" onClick={hideMenu}>Inicio</NavLink>
                            </li>
                            <li>
                                <NavLink to="/productos" onClick={hideMenu}>Productos</NavLink>
                                
                            </li>
                            <li>
                                <NavLink to="/nosotros" onClick={hideMenu}>Nosotros</NavLink>
                            </li>

                            <li>
                                {user ?
                                    <button onClick={() => { setUser(false) }} className="button button--primary mt-auto">Logout</button>
                                    :
                                    <NavLink to="/login" className={"button button--primary m-top"}>Login</NavLink>
